...
#Example inputs: ,
#for 1st tree: internal nodes-> 15,23  leaves: 22,33
#for 2nd tree: internal nodes -> 44,71  leaves:22,33
...
if(node1.is_leaf() and node2.is_leaf() ):   #if both are leaves
        ...
        print("Both nodes are internal node")
        ...
        print("Error: The two nodes are in different types! ")
        exit()
